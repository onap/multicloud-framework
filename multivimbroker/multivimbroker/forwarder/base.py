...
class BaseHandler(object):
    ...
    def _request(self, route_uri, method, body="", headers=None, multipart=False):
    ...
    def send(self, vimid, full_path, body, method, headers=None, multipart=False):
        ...
        return self._request(url, method, body=body, headers=headers, multipart=multipart)

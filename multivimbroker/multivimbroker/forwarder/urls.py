...
urlpatterns = [
    ...
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)/identity/v3$',
        APIv1Identity.as_view()),
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)/identity/v3'
        r'/auth/tokens$', APIv1Identity.as_view()),
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)/registry$',
        APIv1Registry.as_view()),
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)$',
        APIv1UnRegistry.as_view()),
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)/extensions$',
        APIv1Extension.as_view()),
    url(r'^api/multicloud/v1/(?P<cloud_owner>[0-9a-zA-Z_-]+)/(?P<cloud_region_id>[0-9a-zA-Z_-]+)/multipart',

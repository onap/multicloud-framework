...
- `MULTICLOUD-386 <https://jira.onap.org/browse/MULTICLOUD-423>`_
...
`project <https://wiki.onap.org/pages/viewpage.action?pageId=45310604>`_.
...
Quick Links:
  ...
  - `Project Vulnerability Review Table for Multicloud <https://wiki.onap.org/pages/viewpage.action?pageId=45310604>`_
